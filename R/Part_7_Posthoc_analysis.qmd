...
Figure created with sourced script ***FigureS4.R***
...
![Figure S4. Atelectasis percentage on chest CT by obesity categories.](images/FigureS4.jpg)

```{r}
#| include: false
rm(mean_exp,frequencies,percent,chi,FigureS4,
   prop_figS4a,prop_figS4b,prop_figS4b_sub)
```
