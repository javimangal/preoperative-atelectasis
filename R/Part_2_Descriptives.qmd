...
-   Gohel D (2023). *officer: Manipulation of Microsoft Word and PowerPoint Documents*. R package version 0.6.3, <https://CRAN.R-project.org/package=officer>.
...
-   South A, Michael S, Massicotte P (2023). *rnaturalearthhires: High Resolution World Vector Map Data from Natural Earth used in rnaturalearth*. R package version 0.2.1, https://github.com/ropensci/rnaturalearthhires, <https://docs.ropensci.org/rnaturalearthhires>.
...
-   Ushey K, Allaire J, Tang Y (2023). *reticulate: Interface to 'Python'*. R package version 1.34.0, <https://CRAN.R-project.org/package=reticulate>.
